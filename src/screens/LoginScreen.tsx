...
import { Wallet, Mail, Lock, User, Chrome, Sparkles, ArrowRight } from 'lucide-react';

export function LoginScreen() {
  const { signIn, signUp, signInWithGoogle, enterDemo, loading, error } = useApp();
    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 via-cream-50 to-cream-100 flex flex-col justify-center px-6 py-10">
      ...
      <div className="card-elevated p-6 space-y-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2.5 px-5 py-3 rounded-xl bg-white border border-stone-200 text-stone-700 font-semibold hover:bg-cream-50 active:bg-cream-100 transition-colors"
        >
